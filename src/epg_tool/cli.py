...
def _collect(args: argparse.Namespace) -> int:
    ...
    collectors = (
        ...
        ("cbs_us", lambda: collect_cbs(args.days)),
        ("usa_network_us", lambda: collect_usa_network(args.days)),
...
def build_parser() -> argparse.ArgumentParser:
    ...
    search.add_argument("--provider", choices=["astro", "now_hk", "allente_se", "allente_no", "ee_uk", "cbs_us", "usa_network_us", "digi4k_ro", "tvplus_tr"])
